...
#
# This script is used to create a new hadoop cluster, submit a job and an action script and then delete the cluster by making calls to REST APIs.
# The script demonstrates how to invoke the following REST APIs
#		1. Login 
#		2. Switch to specific Tenant and
#		3. Create a CDH591 cluster.
#		4. Submit a Job
#		5. Invoke an ActionScript
#		6. Delete cluster
#
# Requirements:
...
#
# Example Usage:
# ./cluster_pipeline.py -c 10.36.0.17 -u admin -p admin123 
#
#
##############################################################
...
hadoop_cluster_json_filename = "hadoop_cluster.json"
...
print ("Job submitted succesfully!" +response)
...
response = request.post(actionscript_url, data=json.dumps(spark_submit_json), headers=headers)
print ("ActionScript submitted successfully" + response)
