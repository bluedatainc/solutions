...
#
# This script is used to create a new hadoop cluster(In this example it is CDH5.9.1) by making calls to REST APIs.
...
#
# Example Usage:
# ./hadoop_cluster_creation.py -c 10.36.0.17 -u admin -p admin123 
#
#
#
#############################################################
