...
#
# This script is used to retrieve all clusters per tenant by making calls to REST APIs.
# The script demonstrates how to invoke the following REST APIs
#		1. Login 
#		2. Switch to specific Tenant and
#		3. List clusters per Tenant.
#
# Requirements:
...
#
# Example Usage:
# ./retrieve_cluster_per_tenant.py -c 10.36.0.17 -u admin -p admin123 
#
# 
##############################################################
