...
#
# This script is used to create a new spark cluster by making calls to REST APIs.
...
#
# Example Usage:
# ./spark_cluster_creation.py -c 10.36.0.17 -u admin -p admin123 
#
# 
#
###############################################################
...
spark_cluster_json_filename = "spark_cluster.json"
...
spark_cluster_json = json.load(open(spark_cluster_json_filename))
response = requests.post(cluster_url, data=json.dumps(spark_cluster_json), headers=headers)
response.raise_for_status()
